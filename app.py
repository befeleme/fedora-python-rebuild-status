...
def burndown():
    ...
    burndown_313 = load_json("data/burndown_py313.json")
    return render_template('burndown.html', burndown_315=burndown_315, burndown_314=burndown_314, burndown_313=burndown_313, updated=updated)
